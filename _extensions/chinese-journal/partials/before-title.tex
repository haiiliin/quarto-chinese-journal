...
\def\env{$if(table_env)$$table_env$$else$table*$endif$}
\makeatletter
\let\oldlt\longtable
\let\endoldlt\endlongtable
\def\longtable{\@ifnextchar[\longtable@i \longtable@ii}
\def\longtable@i[#1]{\begin{\env}[!htb]\onecolumn\oldlt[#1]}
\def\longtable@ii{\begin{\env}[!htb]\onecolumn\oldlt}
\def\endlongtable{\bottomrule\endoldlt\twocolumn\end{\env}}
\makeatother
